/*******************************************************************
	...
	jbrad2089@gmail.com - Fixed crashing on ESP8266 systems. Must use
	v1.3.6 of Adafruit-GFX-Library and v1.2 of PxMatrix library.
...
// -- NOTE: If using a WeMOS D1 R1 board, it must be the 1.2 version (Compile errors on later versions)

// Adafruit GFX library is a dependancy for the PxMatrix Library
// Can be installed from the library manager
// https://github.com/adafruit/Adafruit-GFX-Library
// -- NOTE: If using a WeMOS D1 R1 board, it must be the 1.3.6 version (Crashes on later versions)
